...
if [[  $(docker images | grep 'netapp/trident' | grep 22.07.0 | wc -l) -ne 3 ]];then
  if [ $# -eq 2 ]; then
  ...
  if [[  $(docker images | grep registry | grep trident | grep 23.07.0 | wc -l) -eq 0 ]]; then
    docker pull netapp/trident:23.07.0
    docker pull netapp/trident-operator:23.07.0
    docker pull netapp/trident-autosupport:23.07.0
  fi

  docker pull netapp/trident:23.04.0
  docker pull netapp/trident-operator:23.04.0
  docker pull netapp/trident-autosupport:23.04.0
fi
...
if [[  $(docker images | grep registry | grep trident | grep 23.07.0 | wc -l) -eq 0 ]]; then
  docker tag netapp/trident:23.07.0 registry.demo.netapp.com/trident:23.07.0
  docker tag netapp/trident-operator:23.07.0 registry.demo.netapp.com/trident-operator:23.07.0
  docker tag netapp/trident-autosupport:23.07.0 registry.demo.netapp.com/trident-autosupport:23.07.0

  docker push registry.demo.netapp.com/trident:23.07.0
  docker push registry.demo.netapp.com/trident-operator:23.07.0
  docker push registry.demo.netapp.com/trident-autosupport:23.07.0
fi

docker tag netapp/trident:23.04.0 registry.demo.netapp.com/trident:23.04.0
docker tag netapp/trident-operator:23.04.0 registry.demo.netapp.com/trident-operator:23.04.0
docker tag netapp/trident-autosupport:23.04.0 registry.demo.netapp.com/trident-autosupport:23.04.0
docker push registry.demo.netapp.com/trident:23.04.0
docker push registry.demo.netapp.com/trident-operator:23.04.0
docker push registry.demo.netapp.com/trident-autosupport:23.04.0
