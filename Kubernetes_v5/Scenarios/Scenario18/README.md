...
This scenario was built around Trident 22.07.0. With the availability of Trident 22.10.0 we also test its upgrade mechanism.  
...
```bash
sed -i 's/22.07.0/22.10.0/' ~/Repository/Infrastructure/Trident-Installer/bundle.yaml
sed -i 's/22.07.0/22.10.0/' ~/Repository/Infrastructure/Trident-Installer/trident-orchestrator.yaml
cd ~/Repository
git adcom "trident update to 22.10.0"
git push
```
