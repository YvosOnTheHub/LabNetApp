...
prometheus-grafana   NodePort   10.102.82.198   <none>        80:30267/TCP   194d
```
...
prometheus-grafana-5cf9c9c659-ggxz7   2/2     Running   0          12h

$ kubectl describe pod prometheus-grafana-5cf9c9c659-ggxz7 -n monitoring | grep GF_SECURITY
...
NAME                 TYPE     DATA   AGE
prometheus-grafana   Opaque   3      194d

$ kubectl describe secrets -n monitoring prometheus-grafana
...
Copy & paste the content of the _trident_dashboard_21_04.json_ file you can find in the Dashboard directory.  
