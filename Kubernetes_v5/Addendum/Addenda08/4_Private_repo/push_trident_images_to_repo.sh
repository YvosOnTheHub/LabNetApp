...
if [[  $(docker images | grep 'netapp/trident' | grep 23.07.1 | wc -l) -ne 3 ]]
  then
    echo "########################################"
...
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident:23.07.1 registry.demo.netapp.com/trident:23.07.1
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident-operator:23.07.1 registry.demo.netapp.com/trident-operator:23.07.1
...
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident:23.07.1
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident-operator:23.07.1
