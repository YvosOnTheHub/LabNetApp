...
do
  helm install trident netapp-trident/trident-operator --version 100.2410.0 -n trident --create-namespace --set tridentAutosupportImage=registry.demo.netapp.com/trident-autosupport:24.10.0 --set operatorImage=registry.demo.netapp.com/trident-operator:24.10.0 --set tridentImage=registry.demo.netapp.com/trident:24.10.0 --set tridentSilenceAutosupport=true --kubeconfig=$tenant.kubeconfig
done
```
