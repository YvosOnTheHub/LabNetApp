#########################################################################################
# SCENARIO 1: Trident upgrade to 26.06.1
#########################################################################################
...
**Very important**: You can perform a direct upgrade to any target release that is within a **four-release window** of your installed version. So technically you *should* first upgrade to 25.02.0 before jumping to 26.02.1. In this lab, it would be much faster (3x) to first fully uninstall Trident and then reinstall it with the new version. 
