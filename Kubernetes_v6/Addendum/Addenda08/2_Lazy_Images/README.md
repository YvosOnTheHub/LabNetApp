...
Here is a list of some images used in this lab with Trident 26.06.0:
- netapp/trident:26.06.0
- netapp/trident-operator:26.06.0
- netapp/trident-autosupport:26.06.0
- ghost:2.6-alpine
- ghost:3.13-alpine
- mysql:5.7
- busybox:1.35.0
