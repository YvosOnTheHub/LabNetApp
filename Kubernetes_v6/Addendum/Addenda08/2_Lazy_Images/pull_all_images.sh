...
echo "####################################"
echo "# netapp/trident:25.10.0"
echo "####################################"
ssh -o "StrictHostKeyChecking no" root@$1 podman pull docker.io/netapp/trident:25.10.0

echo "####################################"
echo "# netapp/trident-operator:25.10.0"
echo "####################################"
ssh -o "StrictHostKeyChecking no" root@$1 podman pull docker.io/netapp/trident-operator:25.10.0

echo "####################################"
echo "# netapp/trident-autosupport:25.10.0"
echo "####################################"
ssh -o "StrictHostKeyChecking no" root@$1 podman pull docker.io/netapp/trident-autosupport:25.10.0
