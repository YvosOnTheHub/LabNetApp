...
This page will guide you through the upgrade to the patch version _1.31.14_. However, if you would like to use a different patch version, you can use the following command to list all available packages:  
```bash
...
kubelet     rhel1     v1.30.14   v1.31.14
kubelet     rhel2     v1.30.14   v1.31.14
kubelet     rhel3     v1.30.14   v1.31.14
kubelet     win1      v1.30.14   v1.31.14
kubelet     win2      v1.30.14   v1.31.14

Upgrade to the latest stable version:

COMPONENT                 NODE      CURRENT    TARGET
kube-apiserver            rhel3     v1.30.14   v1.31.14
kube-controller-manager   rhel3     v1.30.14   v1.31.14
kube-scheduler            rhel3     v1.30.14   v1.31.14
...
[upgrade/version] You have chosen to change the cluster version to "v1.31.14"
...
rhel3   Ready    control-plane   451d   v1.31.14
...
```powershell
curl.exe -Lo c:\k\kubeadm.exe  "https://dl.k8s.io/v1.31.14/bin/windows/amd64/kubeadm.exe"
kubeadm upgrade node

stop-service kubelet
curl.exe -Lo c:\k\kubelet.exe "https://dl.k8s.io/v1.31.14/bin/windows/amd64/kubelet.exe"
...
$ kubectl -n kube-system patch daemonset kube-proxy-windows --type='json' \
  -p='[{"op": "replace", "path": "/spec/template/spec/containers/0/image", "value": "sigwindowstools/kube-proxy:v1.31.14-calico-hostprocess"}]'
