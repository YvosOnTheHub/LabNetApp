...
However, I recommend using Trident 25.10 to get the best of both products.  

The Trident upgrade to 25.10 is already documented [here](../../Trident_Scenarios/Scenario01/).  
