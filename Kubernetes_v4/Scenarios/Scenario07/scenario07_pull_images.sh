...
echo "#################################################"
echo "# PULLING GHOST IMAGE FROM DOCKER HUB ON RHEL1"
echo "#################################################"
ssh -o "StrictHostKeyChecking no" root@rhel1 docker pull ghost:2.6-alpine

echo "#################################################"
echo "# PULLING GHOST IMAGE FROM DOCKER HUB ON RHEL2"
echo "#################################################"
ssh -o "StrictHostKeyChecking no" root@rhel2 docker pull ghost:2.6-alpine

echo "#################################################"
echo "# PULLING GHOST IMAGE FROM DOCKER HUB ON RHEL3"
echo "#################################################"
...
then
    echo "#################################################"
    echo "# PULLING GHOST IMAGE FROM DOCKER HUB ON RHEL4"
    echo "#################################################"
