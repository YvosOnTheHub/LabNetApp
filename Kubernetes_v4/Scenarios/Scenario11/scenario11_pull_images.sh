...
echo "#################################################"
echo "# PULLING MYSQL IMAGE FROM DOCKER HUB ON RHEL1"
echo "#################################################"
ssh -o "StrictHostKeyChecking no" root@rhel1 docker pull mysql:5.7

echo "#################################################"
echo "# PULLING MYSQL IMAGE FROM DOCKER HUB ON RHEL2"
echo "#################################################"
ssh -o "StrictHostKeyChecking no" root@rhel2 docker pull mysql:5.7

echo "#################################################"
echo "# PULLING MYSQL IMAGE FROM DOCKER HUB ON RHEL3"
echo "#################################################"
ssh -o "StrictHostKeyChecking no" root@rhel3 docker pull mysql:5.7

if [ $(kubectl get nodes | wc -l) = 5 ]
then
    echo "#################################################"
    echo "# PULLING MYSQL IMAGE FROM DOCKER HUB ON RHEL4"
    echo "#################################################"
    ssh -o "StrictHostKeyChecking no" root@rhel4 docker pull mysql:5.7
fi 
