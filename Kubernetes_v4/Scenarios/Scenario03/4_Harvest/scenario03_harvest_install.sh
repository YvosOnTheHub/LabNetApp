...
ssh -o "StrictHostKeyChecking no" root@rhel6 wget https://github.com/NetApp/harvest/releases/download/v21.05.4/harvest-21.05.4-2.x86_64.rpm
sleep 15
...
ssh -o "StrictHostKeyChecking no" root@rhel6 yum install -y harvest-21.05.4-2.x86_64.rpm
