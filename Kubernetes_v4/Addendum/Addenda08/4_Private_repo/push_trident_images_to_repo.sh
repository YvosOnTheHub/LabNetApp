...
if [[  $(docker images | grep 'netapp/trident' | grep 21.07.2 | wc -l) -ne 2 ]]
  then
    echo "########################################"
...
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident:21.07.2 registry.demo.netapp.com/trident:21.07.2
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident-operator:21.07.2 registry.demo.netapp.com/trident-operator:21.07.2
...
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident:21.07.2
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident-operator:21.07.2
