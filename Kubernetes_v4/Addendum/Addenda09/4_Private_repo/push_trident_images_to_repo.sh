...
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident:21.04.0 registry.demo.netapp.com/trident:21.04.0
ssh -o "StrictHostKeyChecking no" root@$1 docker tag netapp/trident-operator:21.04.0 registry.demo.netapp.com/trident-operator:21.04.0
...
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident:21.04.0
ssh -o "StrictHostKeyChecking no" root@$1 docker push registry.demo.netapp.com/trident-operator:21.04.0
