...
# 1. UPGRADE HELM
# 2. UPGRADE TRIDENT OPERATOR TO 25.06.0 WITH HELM
...
echo
echo "#######################################################################################################"
echo "# 2. UPGRADE TRIDENT OPERATOR TO 25.06 WITH HELM"
echo "#######################################################################################################"
echo
...
#
# Function that will perform the following tasks:
# 1. UPGRADE TRIDENT TO 25.06 ON KUBERNETES#1
...
# 6. INSTALL TRIDENT PROTECT 25.06 ON KUBERNETES#1
# 7. INSTALL TRIDENT & TRIDENT PROTECT 25.06 ON KUBERNETES#2
...
# Upgrade Trident to 25.06 if needed
if [ $(kubectl get tver trident -n trident -o jsonpath={".trident_version"}) != "25.06.0" ]; then K8S1_trident_upgrade; fi
