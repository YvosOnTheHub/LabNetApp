...
echo "#######################################################################################################"
echo "Upgrading Kubernetes Master RHEL3 to K8s 1.16"
echo "#######################################################################################################"

yum install -y kubeadm-1.16.15-0 --disableexcludes=kubernetes
kubeadm upgrade apply v1.16.15 -y
...
echo "#######################################################################################################"
echo "Upgrading Kubernetes Worker RHEL1 to K8s 1.16"
echo "#######################################################################################################"

ssh -o "StrictHostKeyChecking no" root@rhel1 yum install -y kubeadm-1.16.15-0 --disableexcludes=kubernetesclear
ssh -o "StrictHostKeyChecking no" root@rhel1 kubeadm upgrade node 
ssh -o "StrictHostKeyChecking no" root@rhel1 yum install -y kubelet-1.16.15-0 kubectl-1.16.15-0 --disableexcludes=kubernetes
...
echo "#######################################################################################################"
echo "Upgrading Kubernetes Worker RHEL2 to K8s 1.16"
echo "#######################################################################################################"

ssh -o "StrictHostKeyChecking no" root@rhel2 yum install -y kubeadm-1.16.15-0 --disableexcludes=kubernetesclear
...
then
  echo "#######################################################################################################"
  echo "Upgrading Kubernetes Worker RHEL4 to K8s 1.16"
  echo "#######################################################################################################"

  ssh -o "StrictHostKeyChecking no" root@rhel4 yum install -y kubeadm-1.16.15-0 --disableexcludes=kubernetesclear
...
echo "#######################################################################################################"
echo "Upgrade to Kubernetes 1.16 finished"
echo "#######################################################################################################"
