...
The default is to use all data LIF IPs from the SVM and to use **iSCSI multipath**. Specifying an IP address for the dataLIF for the ontap-san* drivers forces the driver to disable multipath and use only the specified address.  
